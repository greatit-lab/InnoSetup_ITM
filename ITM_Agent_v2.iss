; ================================================================
; ITM Agent System Setup Script (Win10)
; ================================================================
...
OutputDir=.\Output
OutputBaseFilename=ITM_Agent_Setup_v0.1.2.1
...
VersionInfoDescription=ITM Agent System Installer
VersionInfoCopyright=Copyright © 2026 Dev@samsung.com
VersionInfoOriginalFileName=ITM_Agent_Setup_v0.1.2.1.exe
...
begin
  ...
  begin
    MsgBox(
      '이 시스템에는 Microsoft .NET Framework 4.7.2 이상이 필요합니다.' + #13#10 + #13#10 +
      'I:Vision Web 서비스에서 .NET 설치 파일을 다운로드 후 설치해 주세요.',
      mbCriticalError,
      MB_OK
    );
    Result := False;
